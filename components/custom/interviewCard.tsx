...
const InterviewCard = ({
  ...
  return (
    <div className="w-[98%] h-[48vh] md:w-[88%] md:h-[42vh] lg:w-[32%] lg:h-[48vh] aspect-square p-[1px] bg-gradient-to-br from-cyan-400 via-blue-500 to-purple-600 hover:from-cyan-300 hover:via-blue-400 hover:to-purple-500 transition-all duration-300 rounded-md mb-6 md:mb-10">
      <div className="w-full h-full bg-gray-900 hover:bg-gray-800 flex flex-col justify-start items-start transition-all ease-in-out duration-100 hover:cursor-pointer hover:scale-[0.98] p-0 md:p-x-2 lg:p-0 rounded-md">
        {/* Logo and Tag */}
