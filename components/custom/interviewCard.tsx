...
const InterviewCard = ({
  ...
  return (
    <div className="w-[98%] h-[48vh] md:w-[88%] md:h-[42vh] lg:w-[32%] lg:h-[48vh] bg-gray-900/60 hover:bg-neutral-900 rounded-md mb-6 md:mb-10 flex flex-col justify-start items-start transition-all ease-in-out duration-100 hover:cursor-pointer hover:scale-105 border-2 border-gray-800/60 hover:border-2 hover:border-gray-400 p-0 md:p-x-2 lg:p-0">
      {/* Logo and Tag */}
